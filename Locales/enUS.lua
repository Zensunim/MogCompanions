...
L["Settings Dynamic Mount Macro Icon Tooltip"] = "When enabled, the mount macro uses the ? icon so #showtooltip can update the action bar icon when a mount is assigned. When disabled, the macro always uses the mount placeholder icon.";
L["Settings Dynamic Pet Macro Icon"] = "Dynamically change pet icon";
L["Settings Dynamic Pet Macro Icon Tooltip"] = "When enabled, the pet macro uses the ? icon so #showtooltip can update the action bar icon when a selected pet is assigned. When disabled, the macro always uses the pet placeholder icon.";
